...
export const BUILT_LESSONS = {
  ...
  'module-04': {
    easy: [
      ...
      'lesson-priority-matrix',
      'lesson-priority-assignment',
      'lesson-routing-table',
      'lesson-route-decision',
      'lesson-escalation-handoff',
      'lesson-queue-assignment',
      'lesson-sla-tracker',
      'lesson-resolution-record',
      'lesson-misroute-check',
      'lesson-queue-digest',
      'lesson-triage-archive',
      'lesson-taxonomy-feedback',
    ],
    medium: [],
    hard: [],
  },
